...
export default function SummativBaholashPage() {
  ...
  // --- BSB (mezon asosida baholash) holati ---
  ...
  const handleSaveBsbScores = async () => {
    ...
    // Umumiy BSB ballarini grades jadvaliga ham yozamiz (o'rtacha ball hisobiga qo'shilishi uchun)
      ...
      <main className="flex-1 p-6 space-y-6">
        ...
        <Tabs defaultValue="students" className="space-y-4">
          <TabsList>
            ...
            <TabsTrigger value="bsb">BSB nazorati</TabsTrigger>
          ...
          <TabsContent value="bsb" className="space-y-4">
            <div className="flex flex-wrap gap-4 items-end justify-between">
              <div className="flex flex-wrap gap-4">
                ...
                <div className="space-y-1">
                  <Label className="text-xs text-muted-foreground">BSB raqami</Label>
                  <Select value={bsbNumber} onValueChange={setBsbNumber}>
                    <SelectTrigger className="w-[140px]">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="1">1-BSB</SelectItem>
                      <SelectItem value="2">2-BSB</SelectItem>
                      <SelectItem value="3">3-BSB</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
        ...
        <Dialog open={isBsbSetupOpen} onOpenChange={setIsBsbSetupOpen}>
          <DialogContent className="max-w-lg">
            <DialogHeader>
              <DialogTitle>{bsbNumber}-BSB uchun mezonlarni tuzish</DialogTitle>
            </DialogHeader>
            <div className="space-y-4">
              <div className="space-y-2">
                <Label>BSB nomi (ixtiyoriy)</Label>
                <Input
