...
export default function TestResultsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleSaveManualGrading = async () => {
    ...
    // Yakuniy ballni grades jadvaliga ham yozamiz (o'rtacha ball hisobiga qo'shilishi uchun)
    if (assessment) {
  ...
  return (
    <>
      ...
      <main className="flex-1 p-6 space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card className="bg-card border-border">
            <CardContent className="p-4 flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">Topshirdi</p>
          ...
          <Card className="bg-card border-border">
            <CardContent className="p-4 flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">Baholandi</p>
        ...
        <Card className="bg-card border-border">
          <CardHeader>
            <CardTitle className="text-base">O&apos;quvchilar natijalari</CardTitle>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
        ...
        <Dialog open={!!gradingSubmission} onOpenChange={(open) => !open && setGradingSubmission(null)}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>{gradingSubmission?.studentName} — javoblarni baholash</DialogTitle>
            </DialogHeader>
